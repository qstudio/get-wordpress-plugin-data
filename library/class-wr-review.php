...
class WR_Review {
	...
	protected function review_markup() { ?>
		...
		<div class="wr-single">
			<div class="wr-avatar-wrap" style="width:{{gravatar_size}}px;height:{{gravatar_size}}px;"><img class="wr-avatar" data-lazy="{{gravatar_url}}" data-echo="{{gravatar_url}}" alt="{{username}}" width="{{gravatar_size}}" height="{{gravatar_size}}" src="<?php echo QGWPD_URL; ?>assets/images/blank.gif"></div>
	...
	public function tags() {
		...
		$attributes = Q_Get_WordPress_Plugin_Data::$default_review_args;
		$tags       = array();
	...
	public function get_review() {
		...
		// out put adds a string version of the compiled review ##
