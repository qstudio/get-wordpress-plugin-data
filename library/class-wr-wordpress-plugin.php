...
class WR_WordPress_Plugin {
	 ...
	 */
	public function __construct( $plugin_name = 'export-user-data', $plugin_data = null ) {
	...
	protected function get_plugin_reviews() {
		...
		#$this->reviews = get_transient( "wr_reviews_$hash" );
			...
			if ( isset( $this->plugin_data->sections->reviews ) ) {

				$this->reviews = $this->plugin_data->sections->reviews;
				$this->split_reviews();
				#$this->cache_reviews();
